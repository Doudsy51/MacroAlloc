...
## 1.5.0 - Reusable DOCX rendering script (2026-09-15)
...
Note: the versions between 1.2.1 and this 1.5.0 entry (region support, dual-mode rendering, French-render mode) were shipped without a changelog entry; see Git history for that period instead. This 1.5.0 tag matches the shared bundle version in `skill-versions.json`, not a skill-by-skill semantic increment.
